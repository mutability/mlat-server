...
def llh2ecef(lat, lng, h):
    """Converts from WGS84 lat/lon/up to ellipsoid-earth ECEF"""
...
def ecef2llh(x, y, z):
    "Converts from ECEF to WGS84 lat/lon/up"
...
def greatcircle(lat0, lon0, lat1, lon1):
    "Returns a great-circle distance in metres, assuming spherical earth"
...
def ecef_distance(ecef0, ecef1):
    return ((ecef0[0]-ecef1[0])**2 +
            (ecef0[1]-ecef1[1])**2 +
            (ecef0[2]-ecef1[2])**2) ** 0.5
